    ...
    function form($instance)
    {
        ...
        <div class="gmw-widget-wrapper">
            ...
            <p class="gmw-message-box">
                ...
                <a href="http://docs.geomywp.com/single-location-widget/" target="_blank"
                   title="Single Location widget docs">Click here</a> for the full, detailed user guide for this widget.
            </p>
            ...
            <p>
                ...
                <input type="text" id="<?php echo $this->get_field_name('widget_title'); ?>"
                       name="<?php echo $this->get_field_name('widget_title'); ?>"
                       value="<?php if (isset($instance['widget_title'])) echo $instance['widget_title']; ?>"
                       class="widefat"/>
            ...
            <p>
                ...
                <select id="<?php echo $this->get_field_name('item_type'); ?>"
                        name="<?php echo $this->get_field_name('item_type'); ?>"
                        onchange="if ( jQuery(this).val() == 'member' ) { jQuery('p.single-post-wrapper').show() } else { jQuery('p.single-post-wrapper').hide() }; if ( jQuery(this).val() == 'post' ) { jQuery('p.additional-info-wrapper').show() } else { jQuery('p.additional-info-wrapper').hide() };">
                    <?php if (class_exists('GMW_Post_Types_Addon')) { ?>
                        <option
                            value="post" <?php if (isset($instance['item_type']) && $instance['item_type'] == "post") echo 'selected="selected"'; ?>><?php echo _e('Post', 'GMW'); ?></option>
                    <?php } ?>
                    <?php if (class_exists('GMW_Members_Locator_Component')) { ?>
                        <option
                            value="member" <?php if (isset($instance['item_type']) && $instance['item_type'] == "member") echo 'selected="selected"'; ?>><?php echo _e('BuddyPress Member', 'GMW'); ?></option>
                    <?php } ?>
                </select>
                <em style="font-size:12px;color:#777;display:block;margin:5px 0px;">
            ...
            <p>
                ...
                <input id="<?php echo $this->get_field_name('element_id'); ?>" type="text"
                       name="<?php echo $this->get_field_name('element_id'); ?>"
                       value="<?php if (isset($instance['element_id'])) echo $instance['element_id']; ?>"
                       class="widefat"/>
                <em style="font-size:12px;color:#777;display:block;margin:5px 0px;">
            ...
            <p>
                ...
                <input type="text" id="<?php echo $this->get_field_name('item_id'); ?>"
                       name="<?php echo $this->get_field_name('item_id'); ?>"
                       value="<?php if (isset($instance['item_id'])) echo $instance['item_id']; ?>" class="widefat"/>
                <em style="font-size:12px;color:#777;display:block;margin:5px 0px;">
            ...
            <p class="single-post-wrapper" <?php if (isset($instance['item_type']) && $instance['item_type'] != "member") echo 'style="display:none"'; ?>>
                <label for="<?php echo $this->get_field_name('show_in_single_post'); ?>">
                    <input id="<?php echo $this->get_field_name('show_in_single_post'); ?>" type="checkbox" value="1"
                           name="<?php echo $this->get_field_name('show_in_single_post'); ?>" <?php if (!empty($instance['show_in_single_post'])) echo 'checked="checked"'; ?>
                           class="checkbox"/>
            ...
            <p>
                ...
                <input type="text" id="<?php echo $this->get_field_name('elements'); ?>"
                       name="<?php echo $this->get_field_name('elements'); ?>"
                       value="<?php if (isset($instance['elements'])) echo $instance['elements']; ?>" class="widefat"/>
                <em style="font-size:12px;color:#777;display:block;margin:5px 0px;">
            ...
            <p>
                ...
                <input type="checkbox" value="address"
                       name="<?php echo $this->get_field_name('address_fields'); ?>[]" <?php if (isset($instance['address_fields']) && in_array('address', $instance['address_fields'])) echo 'checked="checked"'; ?>
                       class="checkbox"/><label><?php _e('Full address', 'GMW'); ?></label><br/>
                <input type="checkbox" value="street"
                       name="<?php echo $this->get_field_name('address_fields'); ?>[]" <?php if (isset($instance['address_fields']) && in_array('street', $instance['address_fields'])) echo 'checked="checked"'; ?>
                       class="checkbox"/><label><?php _e('Street', 'GMW'); ?></label><br/>
                <input type="checkbox" value="city"
                       name="<?php echo $this->get_field_name('address_fields'); ?>[]" <?php if (isset($instance['address_fields']) && in_array('city', $instance['address_fields'])) echo 'checked="checked"'; ?>
                       class="checkbox"/><label><?php _e('City', 'GMW'); ?></label><br/>
                <input type="checkbox" value="state"
                       name="<?php echo $this->get_field_name('address_fields'); ?>[]" <?php if (isset($instance['address_fields']) && in_array('state', $instance['address_fields'])) echo 'checked="checked"'; ?>
                       class="checkbox"/><label><?php _e('State', 'GMW'); ?></label><br/>
                <input type="checkbox" value="zipcode"
                       name="<?php echo $this->get_field_name('address_fields'); ?>[]" <?php if (isset($instance['address_fields']) && in_array('zipcode', $instance['address_fields'])) echo 'checked="checked"'; ?>
                       class="checkbox"/><label><?php _e('Zipcode', 'GMW'); ?></label><br/>
                <input type="checkbox" value="country"
                       name="<?php echo $this->get_field_name('address_fields'); ?>[]" <?php if (isset($instance['address_fields']) && in_array('country', $instance['address_fields'])) echo 'checked="checked"'; ?>
                       class="checkbox"/><label><?php _e('Country', 'GMW'); ?></label><br/>
            </p>
            ...
            <p class="additional-info-wrapper" <?php if (isset($instance['item_type']) && $instance['item_type'] != "post") echo 'style="display:none"'; ?>>
                ...
                <input type="text" id="<?php echo $this->get_field_name('additional_info'); ?>"
                       name="<?php echo $this->get_field_name('additional_info'); ?>"
                       value="<?php if (isset($instance['additional_info'])) echo $instance['additional_info']; ?>"
                       class="widefat"/>
                <em style="font-size:12px;color:#777;display:block;margin:5px 0px;">
            ...
            <p>
                <label for="<?php echo $this->get_field_name('units'); ?>"><?php echo _e('Distance units', 'GMW'); ?>
                    :</label>
                <select id="<?php echo $this->get_field_name('units'); ?>"
                        name="<?php echo $this->get_field_name('units'); ?>">
                    <option value="m" selected="selected"><?php echo _e('Miles', 'GMW'); ?></option>
                    <option
                        value="k" <?php if (isset($instance['units']) && $instance['units'] == "k") echo 'selected="selected"'; ?>><?php echo _e('Kilometers', 'GMW'); ?></option>
                </select>
            </p>
            <p>
                ...
                <input id="<?php echo $this->get_field_name('map_height'); ?>" type="text"
                       name="<?php echo $this->get_field_name('map_height'); ?>"
                       value="<?php if (isset($instance['map_height'])) echo $instance['map_height']; ?>"
                       class="widefat"/>
                <em style="font-size:12px;color:#777;display:block;margin:5px 0px;">
            ...
            <p>
                ...
                <input type="text" id="<?php echo $this->get_field_name('map_width'); ?>"
                       name="<?php echo $this->get_field_name('map_width'); ?>"
                       value="<?php if (isset($instance['map_width'])) echo $instance['map_width']; ?>"
                       class="widefat"/>
                <em style="font-size:12px;color:#777;display:block;margin:5px 0px;">
            ...
            <p>
                ...
                <select id="<?php echo $this->get_field_name('map_type'); ?>"
                        name="<?php echo $this->get_field_name('map_type'); ?>">
                    <option
                        value="ROADMAP" <?php if (isset($instance['map_type']) && $instance['map_type'] == "ROADMAP") echo 'selected="selected"'; ?>>
                        ROADMAP</options>
                    <option
                        value="SATELLITE" <?php if (isset($instance['map_type']) && $instance['map_type'] == "SATELLITE") echo 'selected="selected"'; ?> >
                        SATELLITE</options>
                    <option
                        value="HYBRID" <?php if (isset($instance['map_type']) && $instance['map_type'] == "HYBRID") echo 'selected="selected"'; ?>>
                        HYBRID</options>
                    <option
                        value="TERRAIN" <?php if (isset($instance['map_type']) && $instance['map_type'] == "TERRAIN") echo 'selected="selected"'; ?>>
                        TERRAIN</options>
                </select>
            </p>
            <p>
                ...
                <select id="<?php echo $this->get_field_name('zoom_level'); ?>"
                        name="<?php echo $this->get_field_name('zoom_level'); ?>">
                    <?php for ($i = 1; $i < 18; $i++): ?>
                        <option
                            value="<?php echo $i; ?> " <?php if (isset($instance['zoom_level']) && $instance['zoom_level'] == $i) echo "selected"; ?>><?php echo $i; ?></option>
                    <?php endfor; ?>
                </select>
            </p>
            <p>
                <input type="checkbox" value="1"
                       name="<?php echo $this->get_field_name('scrollwheel'); ?>" <?php if (isset($instance["scrollwheel"])) echo 'checked="checked"'; ?>
                       class="checkbox"/>
            ...
            <p>
                ...
                <input type="text" id="<?php echo $this->get_field_name('item_map_icon'); ?>"
                       name="<?php echo $this->get_field_name('item_map_icon'); ?>"
                       value="<?php echo (!empty($instance['item_map_icon'])) ? $instance['item_map_icon'] : 'https://maps.google.com/mapfiles/ms/icons/red-dot.png'; ?>"
                       class="widefat"/>
                <em style="font-size:12px;color:#777;display:block;margin:5px 0px;">
            ...
            <p>
                ...
                <input type="text" id="<?php echo $this->get_field_name('item_info_window'); ?>"
                       name="<?php echo $this->get_field_name('item_info_window'); ?>"
                       value="<?php if (isset($instance['item_info_window'])) echo $instance['item_info_window']; ?>"
                       class="widefat"/>
                <em style="font-size:12px;color:#777;display:block;margin:5px 0px;">
            ...
            <p>
                ...
                <input type="text" id="<?php echo $this->get_field_name('user_map_icon'); ?>"
                       name="<?php echo $this->get_field_name('user_map_icon'); ?>"
                       value="<?php echo (!empty($instance['user_map_icon'])) ? $instance['user_map_icon'] : ''; ?>"
                       class="widefat"/>
                <em style="font-size:12px;color:#777;display:block;margin:5px 0px;">
            ...
            <p>
                ...
                <input type="text" id="<?php echo $this->get_field_name('user_info_window'); ?>"
                       name="<?php echo $this->get_field_name('user_info_window'); ?>"
                       value="<?php echo (!empty($instance['user_info_window'])) ? $instance['user_info_window'] : ''; ?>"
                       class="widefat"/>
                <em style="font-size:12px;color:#777;display:block;margin:5px 0px;">
            ...
            <p>
                ...
                <input type="text" id="<?php echo $this->get_field_name('no_location_message'); ?>"
                       name="<?php echo $this->get_field_name('no_location_message'); ?>"
                       value="<?php echo (!empty($instance['no_location_message'])) ? $instance['no_location_message'] : ''; ?>"
                       class="widefat"/>
                <em style="font-size:12px;color:#777;display:block;margin:5px 0px;">
