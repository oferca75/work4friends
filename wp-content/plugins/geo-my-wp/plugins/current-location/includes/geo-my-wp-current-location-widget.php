    ...
    function form($instance)
    {
        ...
        <div class="gmw-widget-wrapper">
            ...
            <p class="gmw-message-box">
                ...
                <a href="http://docs.geomywp.com/current-location-widget/" target="_blank"
                   title="Current Location widget docs">Click here</a> for the full, detailed user guide for this
                widget.
            </p>
            ...
            <p>
                ...
                <input type="text" name="<?php echo $this->get_field_name('elements'); ?>"
            ...
            <p>
                ...
                <input type="text" name="<?php echo $this->get_field_name('location_form_trigger'); ?>"
                       value="<?php if (isset($instance['location_form_trigger'])) echo $instance['location_form_trigger']; ?>"
                       class="widefat"/>
                <em style="font-size:12px;color:#777;display:block;margin:5px 0px;">
            ...
            <p>
                ...
                <input type="text" name="<?php echo $this->get_field_name('address_field_placeholder'); ?>"
                       value="<?php if (isset($instance['address_field_placeholder'])) echo $instance['address_field_placeholder']; ?>"
                       class="widefat"/>
                <em style="font-size:12px;color:#777;display:block;margin:5px 0px;">
            ...
            <p>
                ...
                <input type="text" name="<?php echo $this->get_field_name('address_label'); ?>"
                       value="<?php if (isset($instance['address_label'])) echo $instance['address_label']; ?>"
                       class="widefat"/>
                <em style="font-size:12px;color:#777;display:block;margin:5px 0px;">
            ...
            <p>
                ...
                <input type="text" name="<?php echo $this->get_field_name('user_greeting'); ?>"
                       value="<?php if (isset($instance['user_greeting'])) echo $instance['user_greeting']; ?>"
                       class="widefat"/>
                <em style="font-size:12px;color:#777;display:block;margin:5px 0px;">
            ...
            <p>
                ...
                <input type="text" name="<?php echo $this->get_field_name('guest_greeting'); ?>"
                       value="<?php if (isset($instance['guest_greeting'])) echo $instance['guest_greeting']; ?>"
                       class="widefat"/>
                <em style="font-size:12px;color:#777;display:block;margin:5px 0px;">
            ...
            <p>
                ...
                <input type="text" name="<?php echo $this->get_field_name('map_height'); ?>"
            ...
            <p>
                ...
                <input type="text" name="<?php echo $this->get_field_name('map_width'); ?>"
            ...
            <p>
                ...
                <input type="text" name="<?php echo $this->get_field_name('map_marker'); ?>"
                       value="<?php echo (!empty($instance['map_marker'])) ? $instance['map_marker'] : 'https://maps.google.com/mapfiles/ms/icons/blue-dot.png'; ?>"
                       class="widefat"/>
                <em style="font-size:12px;color:#777;display:block;margin:5px 0px;">
