        ...
        <div id="gmw-your-location-wrapper">
            ...
            <div id="your-location-section">
                ...
                <div id="your-location-section-inner">
                    <input type="text" id="gmw-yl-field"
                           value="<?php echo (isset($location->formatted_address)) ? $location->formatted_address : $fieldsLabel['no_location']; ?>"
                           disabled="disabled"/>
                    <input type="button" id="gmw-yl-edit" class="first"
                           value="<?php echo $fieldsLabel['edit_location']; ?>"/>
                ...
                <div id="gmw-yl-manuall-section">
                    ...
                    <div id="gmw-yl-tabs-section">
                        ...
                        <ul id="gmw-yl-tabs">
                            ...
                            <li id="gmw-yl-address-tab"
                                class="gmw-yl-tab active"><?php echo $fieldsLabel['address']; ?></li>
                        ...
                        <div id="gmw-yl-address-tab-btn-wrapper" class="update-btn-wrapper">
                            <input type="button" id="gmw-yl-get-latlng"
                                   value="<?php echo $fieldsLabel['save_location']; ?>"/>
                        </div>

                        <div id="gmw-yl-latlng-tab-btn-wrapper" class="update-btn-wrapper" style="display:none;">
                            <input type="button" id="gmw-yl-get-address"
                                   value="<?php echo $fieldsLabel['save_location']; ?>"/>
                        </div>
        ...
        foreach ($location_fields[$section][1] as $key => $option) {
            ...
            switch ($option['type']) {
                ...
                case "checkbox" :
                    ?>
                    <label>
                        <input type="checkbox" name="gmw_<?php echo $option['name']; ?>" id="<?php echo $id; ?>"
                               class="<?php echo $class; ?>"
                               value="1" <?php echo implode(' ', $attributes); ?> <?php checked('1', $value); ?> />
                ...
                case "textarea" :
                    ?>
                    <textarea name="gmw_<?php echo $option['name']; ?>" id="<?php echo $id; ?>"
                              class="<?php echo $class; ?>" cols="50"
                              rows="3" <?php echo implode(' ', $attributes); ?> <?php echo $placeholder; ?>>
                ...
                case "select" :
                    ?>
                    <select name="gmw_<?php echo $option['name']; ?>" id="<?php echo $id; ?>"
                            class="<?php echo $class; ?>" <?php echo implode(' ', $attributes); ?>>
                        <?php
                ...
                case "password" :
                    ?>
                    <input id="<?php echo $id; ?>" class="<?php echo $class; ?>" type="password"
                           name="gmw_<?php echo $option['name']; ?>"
                           value="<?php esc_attr_e($value); ?>" <?php echo implode(' ', $attributes); ?> <?php echo $placeholder; ?> />
                    <?php
                    break;

                case "div" :
                    ?>
                    <div id="<?php echo $option['id']; ?>"
                         class="<?php echo $class; ?>" <?php echo implode(' ', $attributes); ?>>
                        <?php echo $title; ?>
                    </div>
                    <?php
                ...
                case "text" :
                    ?>
                    <input type="text" name="gmw_<?php echo $option['name']; ?>" id="<?php echo $id; ?>"
                           class="<?php echo $class; ?>"
                           value="<?php esc_attr_e($value); ?>" <?php echo implode(' ', $attributes); ?> <?php echo $placeholder; ?> />
                    <?php
                    if ($option['desc']) {
                ...
                case "button" :
                    ?>
                    <input type="button" name="gmw_<?php echo $option['name']; ?>" id="<?php echo $id; ?>"
                           class="<?php echo $class; ?>"
                           value="<?php echo $title; ?>" <?php echo implode(' ', $attributes); ?> />
                    <?php
                    break;

                case "hidden" :
                    ?>
                    <input type="hidden" name="gmw_<?php echo $option['name']; ?>" id="<?php echo $id; ?>"
                           class="<?php echo $class; ?> gmw-yl-hidden-field"
                           value="<?php echo $value; ?>" <?php echo implode(' ', $attributes); ?> />
                    <?php
                    break;
