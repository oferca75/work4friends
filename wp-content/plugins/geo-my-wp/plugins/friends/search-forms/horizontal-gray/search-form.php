...
<?php do_action('gmw_before_search_form_template', $gmw); ?>
    ...
    <div
        class="gmw-form-wrapper gmw-form-wrapper<?php echo $gmw['ID']; ?> gmw-fl-form-wrapper gmw-fl-horizontal-gray-form-wrapper">

        <?php do_action('gmw_before_search_form', $gmw); ?>

        <form class="standard-form gmw-form gmw-form-<?php echo $gmw['ID']; ?>" name="gmw_form"
            ...
            <div class="xfield-trigger-wrapper">
                <div class="xfield-trigger"
                     onclick="jQuery(this).closest('form').find('.gmw-fl-form-xprofile-fields').slideToggle();jQuery(this).html(jQuery(this).html() == 'Hide Options' ? 'Show Options' : 'Hide Options');">
