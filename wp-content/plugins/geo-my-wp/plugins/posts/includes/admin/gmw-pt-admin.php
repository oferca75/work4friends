...
class GMW_PT_Admin
{
        ...
        <div class="gmw-ssb">
            <p>
                <input type="checkbox" value="1"
                       name="<?php echo 'gmw_forms[' . $_GET['formID'] . '][' . $section . '][excerpt][use]'; ?>" <?php echo (isset($gmw_forms[$formID][$section]['excerpt']['use'])) ? "checked=checked" : ""; ?> />
            ...
            <p>
                ...
                <input type="text"
                       name="<?php echo 'gmw_forms[' . $_GET['formID'] . '][' . $section . '][excerpt][count]'; ?>"
                       value="<?php if (isset($gmw_forms[$formID][$section]['excerpt']['count'])) echo $gmw_forms[$formID][$section]['excerpt']['count']; ?>"
                       size="5"/>
            </p>
            ...
            <p>
                ...
                <input type="text"
                       name="<?php echo 'gmw_forms[' . $_GET['formID'] . '][' . $section . '][excerpt][more]'; ?>"
                       value="<?php if (isset($gmw_forms[$formID][$section]['excerpt']['more'])) echo $gmw_forms[$formID][$section]['excerpt']['more']; ?>"
                       size="15"/>
            </p>
        </div>
        <?php
    ...
    public function main_settings_post_types($gmw_options, $section, $option)
    {
        ...
        <div>
            <?php foreach (get_post_types() as $post) { ?>
                ...
                <p><label>
                        <input type="checkbox" name="<?php echo 'gmw_options[' . $section . '][post_types][]'; ?>"
                               value="<?php echo $post; ?>" id="<?php echo $post; ?>"
                               class="post-types-tax" <?php echo $checked; ?>>
    ...
    public function form_settings_post_types($gmw_forms, $formID, $section, $option)
    {
        ...
        <div class="posts-checkboxes-wrapper" id="<?php echo $formID; ?>">
            <?php foreach (get_post_types() as $post) { ?>
                ...
                <p>
                    <input type="checkbox"
                           name="<?php echo 'gmw_forms[' . $_GET['formID'] . '][' . $section . '][post_types][]'; ?>"
                           value="<?php echo $post; ?>" id="<?php echo $post; ?>"
                           class="post-types-tax" <?php echo $checked; ?> />
            ...
            <div id="taxonomies-wrapper" style=" padding: 8px;">
                ...
                foreach ($posts as $post) :
                    ...
                    foreach ($taxes as $tax) :
                        ...
                        echo ' style="margin-left: 10px; " />' . __('Dropdown', 'GMW');
                        echo '</span>';
    ...
    public function featured_image($gmw_forms, $formID, $section, $option)
    {
        ...
        <div>
            <p>
                <input type="checkbox"
                       name="<?php echo 'gmw_forms[' . $_GET['formID'] . '][' . $section . '][featured_image][use]'; ?>"
                       value="1" <?php echo (isset($gmw_forms[$formID][$section]['featured_image']['use'])) ? "checked=checked" : ""; ?> />
                <label><?php _e('Yes', 'GMW'); ?></label>
            </p>
            ...
            <p>
                ...
                &nbsp;<input type="text" size="5"
                             name="<?php echo 'gmw_forms[' . $_GET['formID'] . '][' . $section . '][featured_image][width]'; ?>"
                             value="<?php echo (isset($gmw_forms[$formID][$section]['featured_image']['width']) && !empty($gmw_forms[$formID][$section]['featured_image']['width'])) ? $gmw_forms[$formID][$section]['featured_image']['width'] : '200px'; ?>"/>px
            </p>

            <p>
                <?php _e('Height', 'GMW'); ?>:
                &nbsp;<input type="text" size="5"
                             name="<?php echo 'gmw_forms[' . $_GET['formID'] . '][' . $section . '][featured_image][height]'; ?>"
                             value="<?php echo (isset($gmw_forms[$formID][$section]['featured_image']['height']) && !empty($gmw_forms[$formID][$section]['featured_image']['height'])) ? $gmw_forms[$formID][$section]['featured_image']['height'] : '200px'; ?>"/>px
            </p>
        </div>
        <?php
    }
