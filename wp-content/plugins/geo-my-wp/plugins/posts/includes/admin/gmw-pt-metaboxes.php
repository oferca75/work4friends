            ...
            <div class="gmw-location-section-inner">
                ...
                <div class="address">
                    ...
                    <table class="gmw-admin-location-table">
                        <tr>
                            <th><label
                                    for="<?php echo $this->meta_boxes['fields'][0]['id']; ?>"><?php echo $this->meta_boxes['fields'][0]['name']; ?></label>
                            </th>
                            <td><input type="text" name="<?php echo $this->meta_boxes['fields'][0]['id']; ?>"
                                       id="<?php echo $this->meta_boxes['fields'][0]['id']; ?>"
                                       value="<?php echo $post_info->street; ?>"/><br/></td>
                        </tr>
                        <tr>
                            <th><label
                                    for="<?php echo $this->meta_boxes['fields'][1]['id']; ?>"><?php echo $this->meta_boxes['fields'][1]['name']; ?></label>
                            </th>
                            <td><input type="text" name="<?php echo $this->meta_boxes['fields'][1]['id']; ?>"
                                       id="<?php echo $this->meta_boxes['fields'][1]['id']; ?>"
                                       value="<?php echo $post_info->apt; ?>"/><br/></td>
                        </tr>
                        <tr>
                            <th><label
                                    for="<?php echo $this->meta_boxes['fields'][2]['id']; ?>"><?php echo $this->meta_boxes['fields'][2]['name']; ?></label>
                            </th>
                            <td><input type="text" name="<?php echo $this->meta_boxes['fields'][2]['id']; ?>"
                                       id="<?php echo $this->meta_boxes['fields'][2]['id']; ?>"
                                       value="<?php echo $post_info->city; ?>"/><br/></td>
                        </tr>
                        <tr>
                            <th><label
                                    for="<?php echo $this->meta_boxes['fields'][3]['id']; ?>"><?php echo $this->meta_boxes['fields'][3]['name']; ?></label>
                            </th>
                            <td><input type="text" id="<?php echo $this->meta_boxes['fields'][3]['id']; ?>"
                                       class="<?php echo $this->meta_boxes['fields'][3]['id']; ?>"
                                       value="<?php echo $post_info->state; ?>"/><br/></td>
                        </tr>
                        <tr>
                            <th><label
                                    for="<?php echo $this->meta_boxes['fields'][4]['id']; ?>"><?php echo $this->meta_boxes['fields'][4]['name']; ?></label>
                            </th>
                            <td><input type="text" name="<?php echo $this->meta_boxes['fields'][4]['id']; ?>"
                                       id="<?php echo $this->meta_boxes['fields'][4]['id']; ?>"
                                       value="<?php echo $post_info->zipcode; ?>"/><br/></td>
                        </tr>
                        <tr>
                            <th><label
                                    for="<?php echo $this->meta_boxes['fields'][5]['id']; ?>"><?php echo $this->meta_boxes['fields'][5]['name']; ?></label>
                            </th>
                            <td><input type="text" id="<?php echo $this->meta_boxes['fields'][5]['id']; ?>"
                                       class="<?php echo $this->meta_boxes['fields'][5]['id']; ?>"
                                       value="<?php echo $post_info->country; ?>"/><br/></td>
                        </tr>
                        <tr>
                            <th></th>
                            <td><input type="button" id="gmw-admin-getlatlong-btn" class="button-primary"
                                       value="Get Lat/Long" style="margin: 10px 0px;"></td>
                        </tr>
                    </table>
                    <table style="display:none;">
                        ...
                        <tr>
                            <th><label
                                    for="<?php echo $this->meta_boxes['fields'][19]['id']; ?>"><?php echo $this->meta_boxes['fields'][19]['name']; ?></label>
                            </th>
                        </tr>
                        <tr>
                            <td><input type="text" id="<?php echo $this->meta_boxes['fields'][19]['id']; ?>"
                                       name="<?php echo $this->meta_boxes['fields'][19]['id']; ?>"
                                       class="<?php echo $this->meta_boxes['fields'][19]['id']; ?>"
                                       value="<?php echo $post_info->street_number; ?>"/><br/></td>
                        </tr>

                        <tr>
                            <th><label
                                    for="<?php echo $this->meta_boxes['fields'][20]['id']; ?>"><?php echo $this->meta_boxes['fields'][20]['name']; ?></label>
                            </th>
                        </tr>
                        <tr>
                            <td><input type="text" id="<?php echo $this->meta_boxes['fields'][20]['id']; ?>"
                                       name="<?php echo $this->meta_boxes['fields'][20]['id']; ?>"
                                       class="<?php echo $this->meta_boxes['fields'][20]['id']; ?>"
                                       value="<?php echo $post_info->street_name; ?>"/><br/></td>
                        </tr>
                        ...
                        <tr>
                            <td><input type="text" name="<?php echo $this->meta_boxes['fields'][3]['id']; ?>"
                                       class="<?php echo $this->meta_boxes['fields'][3]['id']; ?>"
                                       value="<?php echo $post_info->state; ?>"/><br/></td>
                        </tr>
                        ...
                        <tr>
                            <th><label
                                    for="<?php echo $this->meta_boxes['fields'][16]['id']; ?>"><?php echo $this->meta_boxes['fields'][16]['name']; ?></label>
                            </th>
                        </tr>
                        <tr>
                            <td><input type="text" name="<?php echo $this->meta_boxes['fields'][16]['id']; ?>"
                                       id="<?php echo $this->meta_boxes['fields'][16]['id']; ?>"
                                       class="<?php echo $this->meta_boxes['fields'][16]['id']; ?>"
                                       value="<?php echo $post_info->state_long; ?>" style="width: 100%;"/><br/></td>
                        </tr>
                        ...
                        <tr>
                            <td><input type="text" name="<?php echo $this->meta_boxes['fields'][5]['id']; ?>"
                                       class="<?php echo $this->meta_boxes['fields'][5]['id']; ?>"
                                       value="<?php echo $post_info->country; ?>"/><br/></td>
                        </tr>
                        <tr>
                            <th><label
                                    for="<?php echo $this->meta_boxes['fields'][17]['id']; ?>"><?php echo $this->meta_boxes['fields'][17]['name']; ?></label>
                            </th>
                        </tr>
                        <tr>
                            <td><input type="text" name="<?php echo $this->meta_boxes['fields'][17]['id']; ?>"
                                       id="<?php echo $this->meta_boxes['fields'][17]['id']; ?>"
                                       class="<?php echo $this->meta_boxes['fields'][17]['id']; ?>"
                                       value="<?php echo $post_info->country_long; ?>" style="width: 100%;"/><br/></td>
                        </tr
                        <tr>
                            <th><label
                                    for="<?php echo $this->meta_boxes['fields'][14]['id']; ?>"><?php echo $this->meta_boxes['fields'][14]['name']; ?></label>
                            </th>
                        </tr>
                        <tr>
                            <td><input type="text" name="<?php echo $this->meta_boxes['fields'][14]['id']; ?>"
                                       id="<?php echo $this->meta_boxes['fields'][14]['id']; ?>"
                                       class="<?php echo $this->meta_boxes['fields'][14]['id']; ?>"
                                       value="<?php echo $post_info->address; ?>" style="width: 100%;"/><br/></td>
                        </tr>
                        <tr>
                            <th><label
                                    for="<?php echo $this->meta_boxes['fields'][18]['id']; ?>"><?php echo $this->meta_boxes['fields'][18]['name']; ?></label>
                            </th>
                        </tr>
                        <tr>
                            <td><input type="text" name="<?php echo $this->meta_boxes['fields'][18]['id']; ?>"
                                       id="<?php echo $this->meta_boxes['fields'][18]['id']; ?>"
                                       class="<?php echo $this->meta_boxes['fields'][18]['id']; ?>"
                                       value="<?php echo $post_info->formatted_address; ?>" style="width: 100%;"/><br/>
                            </td>
                        </tr>
                    </table>
                </div>
                <div class="right-side">
                    <div class="coords">
                        ...
                        <table class="gmw-admin-location-table">
                            <tr>
                                <th><label
                                        for="<?php echo $this->meta_boxes['fields'][12]['id']; ?>"><?php echo $this->meta_boxes['fields'][12]['name']; ?></label>
                                </th>
                                <td>
                                    <input type="text" name="<?php echo $this->meta_boxes['fields'][12]['id']; ?>"
                                           id="<?php echo $this->meta_boxes['fields'][12]['id']; ?>"
                                           class="<?php echo $this->meta_boxes['fields'][12]['id']; ?>"
                                           value="<?php echo $post_info->lat; ?>"/>
                                    <input type="hidden" name="gmw_check_lat" id="gmw_check_lat" value"">
                                </td>
                            </tr>
                            <tr>
                                <th><label
                                        for="<?php echo $this->meta_boxes['fields'][13]['id']; ?>"><?php echo $this->meta_boxes['fields'][13]['name']; ?></label>
                                </th>
                                <td>
                                    <input type="text" name="<?php echo $this->meta_boxes['fields'][13]['id']; ?>"
                                           id="<?php echo $this->meta_boxes['fields'][13]['id']; ?>"
                                           class="<?php echo $this->meta_boxes['fields'][13]['id']; ?>"
                                           value="<?php echo $post_info->long; ?>"/>
                                    <input type="hidden" name="gmw_check_long" id="gmw_check_long" value"">
                                </td>
                            </tr>
                            <tr>
                                <th></th>
                                <td><input style="margin: 10px 0px;" type="button" id="gmw-admin-getaddress-btn"
                                           class="button-primary" value="Get Address"/></td>
                            </tr>
                        </table>
                    </div>
                    ...
                    <div class="delete-location-wrapper">
                        ...
                        <div class="delete-locaiton-inner">
                            <input type="button" style="float:none;" id="gmw-admin-delete-btn" class="button-primary"
                                   value="<?php _e('Delete address', 'GMW'); ?>"/>
                        </div>
                    </div>
                    ...
                    <div id="gmw-getting-info" class="location-status-wrapper">
                        ...
                        <div class="location-status-inner">
                            <div id="gmw-location-loader"
                                 style="display:none;background:none; border:0px;height: 23px;"><img
                                    style="width:15px;margin-right: 5px" src="<?php echo GMW_IMAGES; ?>/gmw-loader.gif"
                                    id="ajax-loader-image" alt="" "><?php _e('Loading...', 'GMW'); ?></div>
                            <div id="gmw-good-location-message" class="" style="display:none;height: 23px;">
                                <p><?php _e('Location is ready', 'GMW'); ?></p></div>
                            <div id="gmw-bad-location-message" class="gmw-location-message" style="height: 23px;"><p
                                    style="color:red"><?php _e('A valid address, latitude and longitude are required to save the Location', 'GMW'); ?></p>
                            </div>
                        </div>
                    </div>
            ...
            <div style="padding:5px;">
                ...
                <div class="metabox-tabs-div">
                    <ul class="metabox-tabs" id="metabox-tabs">
                        <li class="active extra-info-tab"><a class="active"
                                                             href="javascript:void(null);"><?php _e('Contact Information', 'GMW'); ?></a>
                        </li>
                        <li class="days-hours-tab"><a
                                href="javascript:void(null);"><?php _e('Days & Hours', 'GMW'); ?></a></li>
                    </ul>
                    ...
                    <div class="extra-info-tab">
                        ...
                        <table class="form-table">
                            <tr>
                                <th><label
                                        for="<?php echo $this->meta_boxes['fields'][6]['id']; ?>"><?php echo $this->meta_boxes['fields'][6]['name']; ?></label>
                                </th>
                                <td><input type="text" name="<?php echo $this->meta_boxes['fields'][6]['id']; ?>"
                                           id="<?php echo $this->meta_boxes['fields'][6]['id']; ?>"
                                           value="<?php echo $post_info->phone; ?>"/></td>
                            </tr>
                            <tr>
                                <th><label
                                        for="<?php echo $this->meta_boxes['fields'][7]['id']; ?>"><?php echo $this->meta_boxes['fields'][7]['name']; ?></label>
                                </th>
                                <td><input type="text" name="<?php echo $this->meta_boxes['fields'][7]['id']; ?>"
                                           id="<?php echo $this->meta_boxes['fields'][7]['id']; ?>"
                                           value="<?php echo $post_info->fax; ?>"/></td>
                            </tr>
                            <tr>
                                <th><label
                                        for="<?php echo $this->meta_boxes['fields'][8]['id']; ?>"><?php echo $this->meta_boxes['fields'][8]['name']; ?></label>
                                </th>
                                <td><input type="text" name="<?php echo $this->meta_boxes['fields'][8]['id']; ?>"
                                           id="<?php echo $this->meta_boxes['fields'][8]['id']; ?>"
                                           value="<?php echo $post_info->email; ?>"
                                           placeholder="<?php echo $this->meta_boxes['fields'][8]['placeholder']; ?>"/>
                                </td>
                            </tr>
                            <tr>
                                <th><label
                                        for="<?php echo $this->meta_boxes['fields'][9]['id']; ?>"><?php echo $this->meta_boxes['fields'][9]['name']; ?></label>
                                </th>
                                <td>
                                    <div style="position: relative;">
                                        <!-- <span style="position: absolute; padding:8px 3px 8px 8px; font-size: 13px; color:#888 ">http://</span> -->
                                        <input type="text" name="<?php echo $this->meta_boxes['fields'][9]['id']; ?>"
                                               id="<?php echo $this->meta_boxes['fields'][9]['id']; ?>"
                                               value="<?php echo $post_info->website; ?>"
                                               placeholder="<?php echo $this->meta_boxes['fields'][9]['placeholder']; ?>"/>
                                    </div>
                                </td>
                            </tr>
                        </table>
                    ...
                    <div class="days-hours-tab">
                        ...
                        <table class="form-table">
                            <tr>
                                <th style="width:30px"><label
                                        for="<?php echo $this->meta_boxes['fields'][15]['id']; ?>"><?php _e('Days', 'GMW'); ?></label>
                                </th>
                                <td style="width:150px"><input type="text"
                                                               name="<?php echo $this->meta_boxes['fields'][15]['id'] . '[0][days]'; ?>"
                                                               id="<?php echo $this->meta_boxes['fields'][15]['id']; ?>"
                                                               value="<?php echo $days_hours[0]['days']; ?>"
                                                               style="width:150px"/><br/></td>
                                <th style="width:30px"><label
                                        for="<?php echo $this->meta_boxes['fields'][15]['id']; ?>"><?php _e('Hours', 'GMW'); ?></label>
                                </th>
                                <td><input type="text"
                                           name="<?php echo $this->meta_boxes['fields'][15]['id'] . '[0][hours]'; ?>"
                                           id="<?php echo $this->meta_boxes['fields'][15]['id']; ?>"
                                           value="<?php echo $days_hours[0]['hours']; ?>" style="width:150px"/><br/>
                                </td>
                            </tr>
                            <tr>
                                <th style="width:30px"><label
                                ...
                                <td style="width:150px"><input type="text"
                                                               name="<?php echo $this->meta_boxes['fields'][15]['id'] . '[1][days]'; ?>"
                                                               id="<?php echo $this->meta_boxes['fields'][15]['id']; ?>"
                                                               value="<?php echo $days_hours[1]['days']; ?>"
                                                               style="width:150px"/><br/></td>
                                <th style="width:30px"><label
                                        for="<?php echo $this->meta_boxes['fields'][15]['id']; ?>"><?php _e('Hours', 'GMW'); ?></label>
                                </th>
                                <td><input type="text"
                                           name="<?php echo $this->meta_boxes['fields'][15]['id'] . '[1][hours]'; ?>"
                                           id="<?php echo $this->meta_boxes['fields'][15]['id']; ?>"
                                           value="<?php echo $days_hours[1]['hours']; ?>" style="width:150px"/><br/>
                                </td>
                            </tr>
                            <tr>
                                <th style="width:30px"><label
                                ...
                                <td style="width:150px"><input type="text"
                                                               name="<?php echo $this->meta_boxes['fields'][15]['id'] . '[2][days]'; ?>"
                                                               id="<?php echo $this->meta_boxes['fields'][15]['id']; ?>"
                                                               value="<?php echo $days_hours[2]['days']; ?>"
                                                               style="width:150px"/><br/></td>
                                <th style="width:30px"><label
                                        for="<?php echo $this->meta_boxes['fields'][15]['id']; ?>"><?php _e('Hours', 'GMW'); ?></label>
                                </th>
                                <td><input type="text"
                                           name="<?php echo $this->meta_boxes['fields'][15]['id'] . '[2][hours]'; ?>"
                                           id="<?php echo $this->meta_boxes['fields'][15]['id']; ?>"
                                           value="<?php echo $days_hours[2]['hours']; ?>" style="width:150px"/><br/>
                                </td>
                            </tr>
                            <tr>
                                <th style="width:30px"><label
                                ...
                                <td style="width:150px"><input type="text"
                                                               name="<?php echo $this->meta_boxes['fields'][15]['id'] . '[3][days]'; ?>"
                                                               id="<?php echo $this->meta_boxes['fields'][15]['id']; ?>"
                                                               value="<?php echo $days_hours[3]['days']; ?>"
                                                               style="width:150px"/><br/></td>
                                <th style="width:30px"><label
                                        for="<?php echo $this->meta_boxes['fields'][15]['id']; ?>"><?php _e('Hours', 'GMW'); ?></label>
                                </th>
                                <td><input type="text"
                                           name="<?php echo $this->meta_boxes['fields'][15]['id'] . '[3][hours]'; ?>"
                                           id="<?php echo $this->meta_boxes['fields'][15]['id']; ?>"
                                           value="<?php echo $days_hours[3]['hours']; ?>" style="width:150px"/><br/>
                                </td>
                            </tr>
                            <tr>
                                <th style="width:30px"><label
                                ...
                                <td style="width:150px"><input type="text"
                                                               name="<?php echo $this->meta_boxes['fields'][15]['id'] . '[4][days]'; ?>"
                                                               id="<?php echo $this->meta_boxes['fields'][15]['id']; ?>"
                                                               value="<?php echo $days_hours[4]['days']; ?>"
                                                               style="width:150px"/><br/></td>
                                <th style="width:30px"><label
                                        for="<?php echo $this->meta_boxes['fields'][15]['id']; ?>"><?php _e('Hours', 'GMW'); ?></label>
                                </th>
                                <td><input type="text"
                                           name="<?php echo $this->meta_boxes['fields'][15]['id'] . '[4][hours]'; ?>"
                                           id="<?php echo $this->meta_boxes['fields'][15]['id']; ?>"
                                           value="<?php echo $days_hours[4]['hours']; ?>" style="width:150px"/><br/>
                                </td>
                            </tr>
                            <tr>
                                <th style="width:30px"><label
                                ...
                                <td style="width:150px"><input type="text"
                                                               name="<?php echo $this->meta_boxes['fields'][15]['id'] . '[5][days]'; ?>"
                                                               id="<?php echo $this->meta_boxes['fields'][15]['id']; ?>"
                                                               value="<?php echo $days_hours[5]['days']; ?>"
                                                               style="width:150px"/><br/></td>
                                <th style="width:30px"><label
                                        for="<?php echo $this->meta_boxes['fields'][15]['id']; ?>"><?php _e('Hours', 'GMW'); ?></label>
                                </th>
                                <td><input type="text"
                                           name="<?php echo $this->meta_boxes['fields'][15]['id'] . '[5][hours]'; ?>"
                                           id="<?php echo $this->meta_boxes['fields'][15]['id']; ?>"
                                           value="<?php echo $days_hours[5]['hours']; ?>" style="width:150px"/><br/>
                                </td>
                            </tr>
                            <tr>
                                <th style="width:30px"><label
                                ...
                                <td style="width:150px"><input type="text"
                                                               name="<?php echo $this->meta_boxes['fields'][15]['id'] . '[6][days]'; ?>"
                                                               id="<?php echo $this->meta_boxes['fields'][15]['id']; ?>"
                                                               value="<?php echo $days_hours[6]['days']; ?>"
                                                               style="width:150px"/><br/></td>
                                <th style="width:30px"><label
                                        for="<?php echo $this->meta_boxes['fields'][15]['id']; ?>"><?php _e('Hours', 'GMW'); ?></label>
                                </th>
                                <td><input type="text"
                                           name="<?php echo $this->meta_boxes['fields'][15]['id'] . '[6][hours]'; ?>"
                                           id="<?php echo $this->meta_boxes['fields'][15]['id']; ?>"
                                           value="<?php echo $days_hours[6]['hours']; ?>" style="width:150px"/><br/>
                                </td>
                            </tr>
                        </table>
                    </div>
