        ...
        <div id="settings-ei_data" class="gmw-settings-panel gmw-import-export-page-tab-wrapper">
            ...
            <div class="postbox">
                ...
                <div class="inside-top">
                    ...
                    <div class="inside">
                        <p>
                            <?php _e("Use the Export and Import data forms below to create a back-up file ( .json ) of GEO my WP's data; the settings of GEO my WP and its add-ons, the forms you created and license keys you might have activated.", "GMW"); ?>
                            <br/>
                            <?php _e("You can use the back-up file to restore the data on this site in case that something goes wrong or you could import it into a different site.", "GMW"); ?>
                            <br/>
                        </p>

                        <p>
                            <?php _e("Please follow the steps of each form below for a complete process of exporting and importing your data.", "GMW"); ?>
                            <br/>
                            <br/>
                ...
                <div class="inside-middle">
                    ...
                    <div class="inside">
                        ...
                        <form method="post"
                              action="<?php echo admin_url('admin.php?page=gmw-tools&tab=import_export'); ?>">
                            <p>
								<span>
									<input type="checkbox" class="cb-export-item" name="export_item[]" value="settings"
                                           checked="checked"/><?php _e('Settings', 'GMW'); ?>
                                    <em class="description"><?php _e('( GEO my WP and its add-ons )', 'GMW'); ?></em>
								</span>
                                <span><input type="checkbox" class="cb-export-item" name="export_item[]" value="forms"
                                             checked="checked"/><?php _e('Forms', 'GMW'); ?></span>
								<span>
									<input type="checkbox" class="cb-export-item" name="export_item[]" value="licenses"
                                           checked="checked"/><?php _e('License Keys', 'GMW'); ?>
                ...
                <div class="inside-bottom">
                    ...
                    <div class="inside">
                        ...
                        <form method="post" enctype="multipart/form-data"
                            ...
                            <p>
                                <span><input type="checkbox" class="cb-import-item" name="import_item[]"
                                             value="settings" checked="checked"/><?php _e('Settings', 'GMW'); ?></span>
                                <span><input type="checkbox" class="cb-import-item" name="import_item[]" value="forms"
                                             checked="checked"/><?php _e('Forms', 'GMW'); ?></span>
                                <span><input type="checkbox" class="cb-import-item" name="import_item[]"
                                             value="licenses"
                                             checked="checked"/> <?php _e('License Keys', 'GMW'); ?></span>
                            </p>
        ...
        <div id="settings-ei_pt_locations" class="gmw-settings-panel gmw-import-export-page-tab-wrapper">
            ...
            <div class="postbox">
                ...
                <div class="inside-top">
                    ...
                    <div class="inside">
                        <p>
                            <?php _e("The forms below will help you in the process of exporting the post types locations created on this site and importing them into a different site.", "GMW"); ?>
                            <br/>
                            <?php printf(__("The export/import forms below need to be used together with the native <a href=\"%s\" target=\"blank\"> WordPress export system*</a> and <a href=\"%s\" target\"_blank\">WordPress importer*</a> for a complete process.", "GMW"), admin_url('export.php'), admin_url('import.php')); ?>
                            <br/>
                        </p>
                        ...
                        <p>
                            <?php _e("Please follow the steps of each form below for a complete process of exporting and importing your post types locations.", "GMW"); ?>
                            <br/>
                        </p>
                        ...
                        <form method="post" enctype="multipart/form-data"
                            ...
                            <p>
                                ...
                                <input type="submit" class="button-secondary"
                                       value="<?php _e("Import", "GMW"); ?>" <?php if (!$check_pm_locations) echo 'disabled="disabled"'; ?>/>
            ...
            <div class="postbox">
                ...
                <div class="inside-top">
                    ...
                    <div class="inside">
                        <p>
                            <?php _e("Using this form you can import locations to GEO my WP using the custom fields of your choice. This can be helpful when you want to import locations created by other plugin and its location data is being saved in custom fields.", "GMW"); ?>
                            <br/>
                        </p>

                        <p>
                            <?php _e("To import the locations click on the \"Set custom field\" link to see the fields. You can choose a custom field from the dropdown menus for each location component that exists in GEO my WP database table.", "GMW"); ?>
                            <br/>
                            <?php _e("Note that the latitude and longitude fields are mandatory as without both of the fields GEO my WP cannot perform the search query.", "GMW"); ?>
                            <br/>
                            <?php _e("Other than the lat/long fields the rest of the fields are optional and search can be performed without them. However, certain fields might be needed for certain features. ", "GMW"); ?>
                            <br/>
                        </p>
                        ...
                        <form method="post" enctype="multipart/form-data"
                            ...
                            ?>
                            <a href="#" id="post-meta-fields-toggle"
                               onclick="event.preventDefault(); jQuery('#post-meta-wrapper').slideToggle();"><?php _e('Set Custom Fields', 'GMW'); ?></a>

                            <div id="post-meta-wrapper" style="display:none">
                                <?php foreach ($fieldsArray as $name => $title) { ?>
                                    <p>
                                        <label><?php echo $title; ?>: </label><br/>
                                        <select id="gmw-import-custom-field-<?php echo $name; ?>"
                                                class="gmw-import-custom-field"
                                                name="gmw_post_meta[<?php echo $name; ?>]">
                                            <option value="" selected="selected"><?php _e('N/A', 'GMW'); ?>
                                                <?php foreach ($cFields as $cField) { ?>
                                            <option <?php if (!empty($saved_field[$name])) selected($saved_field[$name], $cField); ?>
                                                value="<?php echo $cField; ?>"><?php echo $cField; ?></option>
                                            <?php } ?>
                                        </select>
                                    </p>
                                <?php } ?>
                            ...
                            <p>
                                ...
                                <input type="submit" id="import-custom-post-meta-submit" class="button-secondary"
                                       value="<?php _e("Import", "GMW"); ?>"/>
                                <script>
            ...
            <div class="postbox">
                ...
                <div class="inside-top">
                    ...
                    <div class="inside">
                        ...
                        <p>
                            <?php _e("Export/Import locations using CSV file should be used for backup purposes only. The best method for export/import post types locations between different sites is by using the post_meta export/import forms above. ", "GMW"); ?>
                            <br/>
                            <?php _e("Export/import locations between different sites using CSV file can only be done when the posts and thier post ID are equal on both the original site and the target site.", "GMW"); ?>
                            <br/>
                            <?php printf(__("By exporting the locations to CSV file the plugin simply backup GEO my WP's custom database table ( %splaces_locator ) when each location has the post ID it belongs to.", "GMW"), $wpdb->prefix); ?>
                            <br/>
                            <?php _e("And so, when importing the location back from the CSV file the posts from the original site must exists with thier original post ID in the target site. ", "GMW"); ?>
                            <br/>
            ...
            <div class="postbox">
                ...
                <div class="inside-top">
                    ...
                    <div class="inside">
                        ...
                        <p>
                            <?php _e("Use the forms below to import locations created by different plugins into GEO my WP.", "GMW"); ?>
                            <br/>
                ...
                <div class="inside-middle">
                    ...
                    <div class="inside">
                        ...
                        <p>
                            <?php _e("Use this form to import locations created by <a href=\"https://wordpress.org/plugins/store-locator/\" target=\"_blank\">Store Locator plugin</a>.", "GMW"); ?>
                            <br/>
                            <?php _e("Because Store Locator plugin doesn't use post type with its locations new post will need to be created for each location being imported.", "GMW"); ?>
                            <br/>
                            <?php _e("To import the locations from Store Locator plugin first choose from the drop-down menu the post type you would like be used when importing the locations then click the \"Import\" button.", "GMW"); ?>
                            <br/>
                        ...
                        <select id="post-type-selector"
                                name="post_type" <?php if ($store_locator_status == 'inactive') echo 'disabled="disabled"'; ?>>
                        ...
                        <p>
                            ...
                            <input type="submit"
                                   class="button-secondary" <?php if ($store_locator_status == 'inactive') echo 'disabled="disabled"'; ?>
                                   value="<?php _e('Import', 'GMW'); ?>"/>
                        </p>
                        </form>
                        </p>
                ...
                <div class="inside-middle">
                    ...
                    <div class="inside">
                        ...
                        <p>
                            <?php _e("Use this form to import locations created by <a href=\"https://wordpress.org/plugins/mappress-google-maps-for-wordpress/\" target=\"_blank\">MapPress Easy Google Maps</a> plugin.", "GMW"); ?>
                            <br/>
                            <br/>
							<span class="description">
                        ...
                        <p>
                            ...
                            <input type="submit"
                                   class="button-secondary" <?php if ($mappress_status == 'inactive') echo 'disabled="disabled"'; ?>
                                   value="<?php _e('Import', 'GMW'); ?>"/>
                        </p>
                        </form>
                        </p>
