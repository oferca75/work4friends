...
class GMW_Admin
{
            ...
            <div class="wrap">
                <div>
                    ...
                    <div style="padding:15px 15px 0 15px;">
                        ...
                        <input type="radio" class="gmw_form_type" name="gmw_form_type" value="results"
                               onclick="if ( jQuery('#gmw-forms-dropdown-wrapper').is(':visible') ) jQuery('#gmw-forms-dropdown-wrapper').slideToggle();"/>
                    ...
                    <div id="gmw-forms-dropdown-wrapper" style="padding:15px 15px 0 15px;">
                        <select id="gmw_form_id">
                            ...
                            foreach ($forms as $form) {
                                ...
                                ?>
                                <option
                                    value="<?php echo absint($form['ID']); ?>"><?php echo esc_html($form['name']); ?></option>
                                <?php
                            }
                            ?>
                        </select>
                    ...
                    <div style="padding:15px;">
                        ...
                        <a class="button" style="color:#bbb;" href="#"
                           onclick="tb_remove(); return false;"><?php _e("Cancel", "GMW"); ?></a>
                    </div>
                </div>
            </div>
        </div>
    ...
    public function rickey_messick_credit($key, $section, $formID, $gmw)
    {
        ...
        <tr class="gmw-sponsored-credit">
            <td></td>
            <td>
                <span>This tab and features were sponsored by <a href="http://www.rickeymessick.com" target="_blank"
                                                                 title="Rickey Messick Credit">Rickey Messick</a>. Thank you!</span>
            </td>
        </tr>
        <?php
    }
