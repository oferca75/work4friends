...
function gmw_admin_support_button()
{
    ...
    if (!empty($_GET['page']) && $_GET['page'] != 'gmw-forms') { ?>
        ...
        <a class="button action gmw-donate" title="Donate to GEO my WP"
           href="https://www.paypal.com/cgi-bin/webscr?cmd=_s-xclick&hosted_button_id=7FK9DTB9N2EEU" target="_blank"><i
                style="color:red;margin-right:4px;" class="fa fa-heart"></i>Donate</a>
    <?php } ?>
    <span class="gmw-helpful-links-wrapper">
		<a class="button action" title="GEO my WP Official Website" href="http://geomywp.com" target="_blank"><i
                class="fa fa-map-marker"></i>Geomywp.com</a>
		<a class="button action" title="GEO my WP documentation" href="http://docs.geomywp.com" target="_blank"><i
                class="fa fa-book"></i>Docs</a>
		<a class="button action" title="GEO my WP Demo" href="http://demo.geomywp.com" target="_blank"><i
                class="fa fa-desktop"></i>Demo</a>
		<a class="button action" title="GEO my WP support" href="http://geomywp.com/support" target="_blank"><i
                class="fa fa-life-ring"></i>Support</a>
		<a class="button action" title="GEO my WP on GitHub" href="https://github.com/Fitoussi/GEO-my-WP"
           target="_blank"><i class="fa fa-github"></i>GitHub</a>
		<a class="button action" title="GEO my WP Extensions" href="http://geomywp.com/add-ons" target="_blank"
           style="color:green"><i class="fa fa-puzzle-piece"></i>Extensions</a>
		<a class="button action" title="Show your support"
           href="https://wordpress.org/support/view/plugin-reviews/geo-my-wp?filter=5" target="_blank"><i
                style="color:orange" class="fa fa-star"></i>Love</a>
		<a class="button action" title="GEO my WP on Facebook" href="https://www.facebook.com/geomywp"
           target="_blank"><i style="color:blue;font-size: 16px" class="fa fa-facebook-official"></i>Like</a>
		<a class="button action" title="GEO my WP on Twitter" href="https://twitter.com/GEOmyWP" target="_blank"><i
                style="color:lightblue;font-size: 16px;" class="fa fa-twitter-square"></i>Follow</a>
	</span>
    <?php
}