                ...
                <?php foreach ($this->shortcodes as $key => $options) { ?>
                    ...
                    <div id="settings-<?php echo sanitize_title($key); ?>" class="gmw-settings-panel">
                        ...
                        <table class="widefat fixed" style="margin-bottom:5px;margin-top: -2px;">
                            ...
                            <tr>
                                <th scope="col" id="cb" class="manage-column column-cb check-column"
                                    style="width:20%;padding:11px 10px;">
                                    <label><?php _e('Post/Page Content Usage', 'GMW'); ?></label>
                                </th>
                                <th scope="col" id="cb" class="manage-column column-cb check-column"
                                    style="width:40%;padding:11px 10px;">
                        ...
                        <table class="widefat fixed" style="margin-top:10px;">
                            ...
                            <tr>
                                <th scope="col" id="cb" class="manage-column column-cb check-column"
                                    style="text-align:center;padding:11px 10px;"><?php _e('Shortcode Attributes', 'GMW'); ?></th>
                            </tr>
                            </thead>
                        </table>
                        ...
                        <table class="widefat fixed" style="margin-top:-2px">
                            ...
                            <tr valign="top">
                                <th scope="col" id="cb" class="manage-column column-cb check-column"
                                    style="width:50px;padding:11px 10px"><?php _e('Attribute', 'GMW'); ?></th>
                                <th scope="col" id="cb" class="manage-column column-cb check-column"
                                    style="width:50px;padding:11px 10px"><?php _e('Values Accepted', 'GMW'); ?></th>
                                <th scope="col" id="cb" class="manage-column column-cb check-column"
                                    style="width:50px;padding:11px 10px"><?php _e('Default Value', 'GMW'); ?></th>
                                <th scope="col" id="cb" class="manage-column column-cb check-column"
                                    style="width:50px;padding:11px 10px"><?php _e('Additional Information', 'GMW'); ?></th>
                            </tr>
                            </thead>
                            <tbody>
                            <?php
                            ...
                            foreach ($options['attributes'] as $attr) {
                                ...
                                <tr valign="top">
                                    <th scope="row" style="color: #555;border-bottom:1px solid #eee;"><label
                                            for="setting-google_api"><?php echo $attr['attr']; ?></label></th>
                                    <td style="color: #555;border-bottom:1px solid #eee;min-width:400px;vertical-align: top">
                                    ...
                                    <td style="color: #555;border-bottom:1px solid #eee;min-width:400px;vertical-align: top">
                                        <p class="description"><?php echo $default; ?></p></td>
                                    <td style="color: #555;border-bottom:1px solid #eee;min-width:400px;vertical-align: top">
                                        <p class="description"><?php echo $attr['desc']; ?></p></td>
                                </tr>
                                <?php
                                $rowNumber++;
                            }
                        ...
                        <table class="widefat fixed" style="margin-top:10px;">
                            ...
                            <tr>
                                <th scope="col" id="cb" class="manage-column column-cb check-column"
                                    style="text-align:center;padding:11px 10px;"><?php _e('Shortcode Examples', 'GMW'); ?></th>
                            </tr>
                            </thead>
                        </table>
                        ...
                        <?php if (isset($options['examples']) && !empty($options['examples'])) { ?>
                            <table class="widefat fixed" style="margin-top:-2px">
                                ...
                                <tr valign="top">
                                    <th scope="col" id="cb" class="manage-column column-cb check-column"
                                        style="width:50px;padding:11px 10px"><?php _e('Usage', 'GMW'); ?></th>
                                    <th scope="col" id="cb" class="manage-column column-cb check-column"
                                        style="width:50px;padding:11px 10px"><?php _e('Description', 'GMW'); ?></th>
                                </tr>
                                </thead>
                                <tbody>
                                <?php
                                ...
                                foreach ($options['examples'] as $example) {
                                    ...
                                    <tr valign="top">
                                        <th scope="row" style="color: #555;border-bottom:1px solid #eee;"><label
                                                for="setting-google_api"><code><?php echo $example['example']; ?></code></label>
                                        </th>
                                        <td style="color: #555;border-bottom:1px solid #eee;min-width:400px;vertical-align: top">
                                            <p class="description"><?php echo $example['desc']; ?></p></td>
                                    </tr>
                                    <?php
                                    $rowNumber++;
                                }
