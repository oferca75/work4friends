...
class GMW_Edit_Form
{
    ...
    public static function form_settings_address_field($gmw_forms, $formID, $section, $option)
    {
        ...
        <div>
            <p>
                <?php _e('Label', 'GMW'); ?>:
                <input type="text"
                       name="<?php echo 'gmw_forms[' . $_GET['formID'] . '][' . $section . '][address_field][title]'; ?>"
                       size="30" placeholder="<?php _e('enter title for the address field', 'GMW'); ?>"
                       value="<?php echo (isset($gmw_forms[$formID][$section]['address_field']['title'])) ? $gmw_forms[$formID][$section]['address_field']['title'] : ''; ?>"/>
            </p>

            <p>
                <input type="checkbox" value="1"
                       name="<?php echo 'gmw_forms[' . $_GET['formID'] . '][' . $section . '][address_field][within]'; ?>" <?php if (isset($gmw_forms[$formID][$section]['address_field']['within'])) echo 'checked="checked"'; ?>>
                <?php _e('Label within the input field', 'GMW'); ?>
            </p>

            <p>
                <input type="checkbox" value="1"
                       name="<?php echo 'gmw_forms[' . $_GET['formID'] . '][' . $section . '][address_field][mandatory]'; ?>" <?php if (isset($gmw_forms[$formID][$section]['address_field']['mandatory'])) echo 'checked="checked"'; ?>>
                <?php _e('Mandatory Field', 'GMW'); ?>
            </p>

            <p>
                <input type="checkbox" value="1"
                       name="<?php echo 'gmw_forms[' . $_GET['formID'] . '][' . $section . '][address_field][address_autocomplete]'; ?>" <?php if (isset($gmw_forms[$formID][$section]['address_field']['address_autocomplete'])) echo 'checked="checked"'; ?>>
    ...
    public static function auto_results($gmw_forms, $formID, $section, $option)
    {
        ...
        <div>
            <p>
                <input name="<?php echo 'gmw_forms[' . $_GET['formID'] . '][' . $section . '][auto_search][on]'; ?>"
                       type="checkbox"
                       value="1" <?php if (isset($gmw_forms[$formID][$section]['auto_search']['on'])) echo "checked='checked'"; ?>/>
            ...
            <p>
                ...
                <?php _e('Radius', 'GMW'); ?>
                <input type="text" id="gmw-auto-radius"
                       name="<?php echo 'gmw_forms[' . $_GET['formID'] . '][' . $section . '][auto_search][radius]'; ?>"
                       size="5"
                       value="<?php echo (isset($gmw_forms[$formID][$section]['auto_search']['radius'])) ? $gmw_forms[$formID][$section]['auto_search']['radius'] : "50"; ?>"/>
            </p>

            <p>
                <select id="gmw-auto-units"
                        name="<?php echo 'gmw_forms[' . $_GET['formID'] . '][' . $section . '][auto_search][units]'; ?>">
                    <option value="imperial" <?php echo 'selected="selected"'; ?>><?php _e('Miles', 'GMW'); ?></option>
                    <option
                        value="metric" <?php if (isset($gmw_forms[$formID][$section]['auto_search']['units']) && $gmw_forms[$formID][$section]['auto_search']['units'] == "metric") echo 'selected="selected"'; ?>><?php _e('Kilometers', 'GMW'); ?></option>
                </select>
            </p>
        </div>
        <?php
            ...
            <form method="post" action="options.php">
                    ...
                    <table class="widefat">
                        ...
                        <tr>
                            <th scope="col" id="cb" class="manage-column column-cb check-column"
                                style="width:18% !important;padding:11px 10px"><?php _e('Form Details', 'GMW'); ?></th>
                            <th></th>
                        </tr>
                        </thead>
                        <tbody>
                        ...
                        <tr valign="top">
                            ...
                            <td class="gmw-form-feature-settings">
                                <input type="text" name="gmw_forms[<?php echo $formID; ?>][name]"
                                       value="<?php echo (isset($gmw_forms[$formID]['name']) && !empty($gmw_forms[$formID]['name'])) ? $gmw_forms[$formID]['name'] : 'form_id_' . $gmw_forms[$formID]['ID']; ?>"/>
	                        		<span style="margin-left: 5px">
	                        			<input type="submit" class="button-primary"
                                               value="<?php _e('Save Changes', 'GMW'); ?>"/>
	                        		</span>
                            </td>
                        </tr>
                        <tr valign="top">
                            ...
                            <td class="gmw-form-feature-settings">
	                            	<span style="margin-left: 5px">
	                            		<a class="button action" title="<?php __('Delete this form', 'GMW'); ?>"
                                           href="admin.php?page=gmw-forms&gmw_action=delete_form&formID=<?php echo $formID; ?>"
                                           onclick="return confirm('sure?');"><?php _e('Delete This Form', 'GMW'); ?></a>
	                            	</span>
	                            	<span style="margin-left: 5px">
	                            		<a class="button action" title="<?php __('Go back to list of forms', 'GMW'); ?>"
                                           href="<?php echo admin_url('admin.php?page=gmw-forms'); ?>"><?php _e('Go Back To List of Forms', 'GMW'); ?></a>
	                            	</span>
	                            	<span>
                ...
                foreach ($this->form_settings as $key => $section) {
                    ...
                    <div id="settings-<?php echo sanitize_title($key); ?>" class="gmw-settings-panel">
                        <table class="widefat">
                            ...
                            <tr>
                                <th scope="col" id="cb" class="manage-column column-cb check-column"
                                    style="width:18% !important;padding:11px 10px"><?php _e('Feature', 'GMW'); ?></th>
                                <th scope="col" id="cb" class="manage-column column-cb check-column"
                                    style="width:57%;padding:11px 10px">
                                    <?php _e('Settings', 'GMW'); ?>
                                ...
                                switch ($option['type']) {
                                    ...
                                    case "multicheckbox" :
                                        foreach ($option['options'] as $keyVal => $name) {
                                            ?><p><label><input
                                                    id="setting-<?php echo $key . '-' . $option['name'] . '-' . $keyVal; ?>"
                                                    class="setting-<?php echo $option['name']; ?>"
                                                    name="<?php echo 'gmw_forms[' . $formID . '][' . $key . '][' . $option['name'] . '][' . $keyVal . ']'; ?>"
                                                    type="checkbox"
                                                    value="<?php echo $checkboxDefault; ?>" <?php if (isset($gmw_forms[$formID][$key][$option['name']][$keyVal]) && $gmw_forms[$formID][$key][$option['name']][$keyVal] == $checkboxDefault) echo 'checked="checked"'; ?> /> <?php echo $name; ?>
                                            </label></p> <?php
                                        }
                                        break;
                                    ...
                                    case "multicheckboxvalues" :
                                        foreach ($option['options'] as $keyVal => $name) {
                                            ?><p><label><input
                                                    id="setting-<?php echo $key . '-' . $option['name'] . '-' . $keyVal; ?>"
                                                    class="setting-<?php echo $option['name']; ?> setting-<?php echo $key . '-' . $option['name']; ?>"
                                                    name="<?php echo 'gmw_forms[' . $formID . '][' . $key . '][' . $option['name'] . '][]'; ?>"
                                                    type="checkbox"
                                                    value="<?php echo $keyVal; ?>" <?php if (!empty($gmw_forms[$formID][$key][$option['name']]) && in_array($keyVal, $gmw_forms[$formID][$key][$option['name']])) echo 'checked="checked"'; ?> /> <?php echo $name; ?>
                                            </label></p> <?php
                                        }
                                        break;

                                    case "checkbox" :
                                        ?><p><label><input id="setting-<?php echo $key . '-' . $option['name']; ?>"
                                                           class="setting-<?php echo $option['name']; ?>"
                                                           name="<?php echo 'gmw_forms[' . $formID . '][' . $key . '][' . $option['name'] . ']'; ?>"
                                                           type="checkbox"
                                                           value="<?php echo $checkboxDefault; ?>" <?php echo implode(' ', $attributes); ?> <?php checked($checkboxDefault, $value); ?> /> <?php echo $option['cb_label']; ?>
                                        </label></p><?php
                                        break;

                                    case "textarea" :
                                        ?><textarea id="setting-<?php echo $key . '-' . $option['name']; ?>"
                                                    class="large-text" cols="50" rows="3"
                                                    name="<?php echo 'gmw_forms[' . $formID . '][' . $key . '][' . $option['name'] . ']'; ?>" <?php echo implode(' ', $attributes); ?><?php echo $placeholder; ?>><?php echo esc_textarea($value); ?></textarea><?php
                                        break;
                                    ...
                                    case "select" :
                                        ?><select id="setting-<?php echo $key . '-' . $option['name']; ?>"
                                                  class="regular-text"
                                                  name="<?php echo 'gmw_forms[' . $formID . '][' . $key . '][' . $option['name'] . ']'; ?>" <?php echo implode(' ', $attributes); ?>><?php
                                        foreach ($option['options'] as $keyVal => $name)
                                    ...
                                    case "multiselect" :
                                        ?><select multiselect id="setting-<?php echo $key . '-' . $option['name']; ?>"
                                                  class="regular-text"
                                                  name="<?php echo 'gmw_forms[' . $formID . '][' . $key . '][' . $option['name'] . '][]'; ?>" <?php echo implode(' ', $attributes); ?>><?php
                                        foreach ($option['options'] as $keyVal => $name) {
                                    ...
                                    case "password" :
                                        ?><input id="setting-<?php echo $key . '-' . $option['name']; ?>"
                                                 class="regular-text" type="password"
                                                 name="<?php echo 'gmw_forms[' . $formID . '][' . $key . '][' . $option['name'] . ']'; ?>"
                                    ...
                                    case "hidden" :
                                        ?><input id="setting-<?php echo $key . '-' . $option['name']; ?>"
                                                 class="gmw-form-hidden-field"
                                                 id="setting-<?php echo $option['name']; ?>" class="regular-text"
                                                 type="hidden"
                                                 name="<?php echo 'gmw_forms[' . $formID . '][' . $key . '][' . $option['name'] . ']'; ?>"
                            ...
                            <tr style="height:40px;">
                                <th scope="col" id="cb" class="manage-column  column-cb check-column"
                                    style="width:50px;padding:11px 10px">
                                    <input type="submit" class="button-primary"
                                           value="<?php _e('Save Changes', 'GMW'); ?>"/>
                                </th>
                ...
                <div id="settings-form-usage" class="gmw-settings-panel">
                    <table class="widefat">
                        ...
                        <tr>
                            <th scope="col" id="cb" class="manage-column column-cb check-column"
                                style="width:20% !important;padding:11px 10px"><?php _e('Post/Page Content', 'GMW'); ?></th>
                            <th scope="col" id="cb" class="manage-column column-cb check-column"
                                style="width:40% !important;padding:11px 10px"><?php _e('Tempalte file', 'GMW'); ?></th>
                            <th scope="col" id="cb" class="manage-column column-cb check-column"
                                style="width:40%;padding:11px 10px"><?php _e('Description', 'GMW'); ?></th>
                        </tr>
                        </thead>
