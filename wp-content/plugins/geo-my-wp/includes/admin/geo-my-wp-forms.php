            ...
            <table class="widefat" style="margin-top: 10px">
                ...
                <tr>
                    <th scope="col" id="cb" class="manage-column column-cb check-column"
                        style="width:50px;padding:11px 10px"><?php _e('ID', 'GMW'); ?></th>
                    ...
                    <?php foreach ($this->forms as $key => $option) : ?>
                        ...
                        <?php if (!empty($option['addon']) && !empty($this->addons[$option['addon']]) && $this->addons[$option['addon']] == 'active') : ?>
                            ...
                            <tr class="<?php echo $alternate; ?>" style="height:50px;">
                                ...
                                <td>
                                    <span><a title="<?php __('Edit this form', 'GMW'); ?>"
                                             href="admin.php?page=gmw-forms&gmw_action=edit_form&gmw_form_title=<?php echo $option['form_title']; ?>&gmw_form_prefix=<?php echo $option['prefix']; ?>&form_type=<?php echo $option['form_type']; ?>&formID=<?php echo $option['ID']; ?>"><?php echo $option['form_title']; ?></a></span>
                                </td>
                                <td>
                                        <span>
                                        	<a title="<?php echo $formName; ?>"
                                               href="admin.php?page=gmw-forms&gmw_action=edit_form&gmw_form_title=<?php echo $option['form_title']; ?>&gmw_form_prefix=<?php echo $option['prefix']; ?>&form_type=<?php echo $option['form_type']; ?>&formID=<?php echo $option['ID']; ?>&gmw_form_name=<?php echo $formName; ?>"><?php echo $formName; ?></a></span>
                                </td>
                                <td>
                                        <span class="edit">
                                            <a title="<?php __('Edit this form', 'GMW'); ?>"
                                               href="admin.php?page=gmw-forms&gmw_action=edit_form&gmw_form_title=<?php echo $option['form_title']; ?>&gmw_form_prefix=<?php echo $option['prefix']; ?>&form_type=<?php echo $option['form_type']; ?>&formID=<?php echo $option['ID']; ?>"><?php _e('Edit', 'GMW'); ?></a> |
                                        </span>
                                        <span class="edit">
                                            <a title="<?php __('Duplicate this form', 'GMW'); ?>"
                                               href="admin.php?page=gmw-forms&gmw_action=duplicate_form&form_type=<?php echo $option['form_type']; ?>&formID=<?php echo $option['ID']; ?>&gmw_form_id=<?php echo $nextFormID; ?>"><?php _e('Duplicate', 'GMW'); ?></a> |
                                        </span>
                                        <span class="edit">
                                            <a title="<?php __('Delete this form', 'GMW'); ?>"
                                               href="admin.php?page=gmw-forms&gmw_action=delete_form&formID=<?php echo $option['ID']; ?>"
                                               onclick="return confirm( 'sure?' ); "><?php _e('Delete', 'GMW'); ?></a>
                                        </span>
                                </td>
