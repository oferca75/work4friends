                        ...
                        <table class="widefat">
                            ...
                            <tr>
                                <th scope="col" id="cb" class="manage-column column-cb check-column"
                                    style="width:20%;padding:11px 10px"><?php _e('Feature', 'GMW'); ?></th>
                                <th scope="col" id="cb" class="manage-column column-cb check-column"
                                    style="width:35%;padding:11px 10px"><?php _e('Settings', 'GMW'); ?></th>
                            </tr>
                            </thead>
                            <tbody>
                            <?php
                            ...
                            foreach ($section[1] as $option) {
                                ...
                                switch ($option['type']) {
                                    ...
                                    case "checkbox" :
                                        ?><label><input class="setting-<?php echo $option['name']; ?>"
                                                        name="<?php echo 'gmw_options[' . $key . '][' . $option['name'] . ']'; ?>"
                                                        type="checkbox"
                                    ...
                                    case "multicheckbox" :
                                        foreach ($option['options'] as $keyVal => $name) {
                                            ?><label><input class="setting-<?php echo $option['name']; ?>"
                                                            name="<?php echo 'gmw_options[' . $key . '][' . $option['name'] . '][' . $keyVal . ']'; ?>"
                                                            type="checkbox"
                                                            value="1" <?php if (isset($gmw_options[$key][$option['name']][$keyVal]) && $gmw_options[$key][$option['name']][$keyVal] == 1) echo 'checked="checked"'; ?> /> <?php echo $name; ?>
                                            </label><br/> <?php
                                        }
                                        break;
                                    ...
                                    */
                                    case "textarea" :
                                        ?><textarea id="setting-<?php echo $option['name']; ?>" class="large-text"
                                                    cols="50" rows="3"
                                                    name="<?php echo 'gmw_options[' . $key . '][' . $option['name'] . ']'; ?>" <?php echo implode(' ', $attributes); ?><?php echo $placeholder; ?>><?php echo esc_textarea($value); ?></textarea><?php
                                        break;
                                    ...
                                    case "select" :
                                        ...
                                        <select id="setting-<?php echo $option['name']; ?>" class="regular-text"
                                                name="<?php echo 'gmw_options[' . $key . '][' . $option['name'] . ']'; ?>" <?php echo implode(' ', $attributes); ?>>
