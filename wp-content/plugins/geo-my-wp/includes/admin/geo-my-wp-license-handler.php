                ...
                <td class="plugin-update" colspan="3">
                    ...
                    <div class="gmw-license-key-fields-wrapper">
                        ...
                        <form method="post" action="">
                            ...
                            <input type="hidden" name="gmw_item_name"
                                   value="<?php echo esc_attr($this->item_name); ?>"/>
                            <input type="hidden" name="gmw_item_id" value="<?php echo esc_attr($this->item_id); ?>"/>
                            <input type="hidden" name="gmw_update_key_api"
                                   value="<?php echo esc_attr($this->license_name); ?>"/>
