...
(function () {
    ...
    O = function (b, a) {
        ...
        f = b.toLowerCase();
        f = u(f);
        for (d = j = 0; 0 <= e ? j < e : j > e; d = 0 <= e ? ++j : --j)for (c = k = d; d <= e ? k < e : k > e; c = d <= e ? ++k : --k)if (f.slice(d, +c + 1 || 9E9) in a)i = f.slice(d, +c + 1 || 9E9), g = a[i], h.push({
            pattern: "dictionary",
            i: d,
            j: c,
            ...
            if (a.length) {
                ...
                for (n = r.length; l < n; l++) {
                    ...
                    for (o = j.length; p < o; p++) {
                        ...
                        -1 === f ? (f = k.concat([[a, e]]), i.push(f)) : (g = k.slice(0), g.splice(f, 1), g.push([a, e]), i.push(k), i.push(g))
                    }
                }
                j = d(i);
                return c(h)
    ...
    N = function (b) {
        ...
        for (m = s.length; k < m; k++) {
            ...
            6 >= c.length && (d.push({
                ...
                i: g,
                j: h
            }), d.push({daymonth: c.slice(0, a - 2), year: c.slice(a - 2), i: g, j: h}));
            6 <= c.length && (d.push({daymonth: c.slice(4), year: c.slice(0, 4), i: g, j: h}), d.push({
                daymonth: c.slice(0,
            ...
            for (p = c.length; l < p; l++)a = c[l], f = parseInt(a.day),
                i = parseInt(a.month), j = parseInt(a.year), f = y(f, i, j), d = f[0], j = f[1], f = j[0], i = j[1], j = j[2], d && e.push({
                pattern: "date",
                i: a.i,
                j: a.j,
    ...
    M = function (b) {
        ...
        k = [];
        i = 0;
        for (j = e.length; i < j; i++)c = e[i], a = y(c.day, c.month, c.year), g = a[0], h = a[1], a = h[0], f = h[1], h = h[2], g && k.push({
            pattern: "date",
            i: c.i,
            j: c.j,
    ...
    B = v.concat([function (b) {
        ...
        g = [];
        c = 0;
        for (e = f.length; c < e; c++)a = f[c], d = [a.i, a.j], a = d[0], d = d[1], g.push({
            pattern: "digits",
            i: a,
            j: d,
            token: b.slice(a, +d + 1 || 9E9)
