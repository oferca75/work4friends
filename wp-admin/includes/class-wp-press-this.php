...
class WP_Press_This
{
                ...
                <div class="post-actions">
                    ...
                    <div class="split-button">
                        ...
                        <ul class="split-button-body">
                            <li>
                                <button type="button"
                                        class="button-subtle draft-button split-button-option"><?php _e('Save Draft'); ?></button>
                            </li>
                            <li>
                                <button type="button"
                                        class="button-subtle standard-editor-button split-button-option"><?php _e('Standard Editor'); ?></button>
                            </li>
                            <li>
                                <button type="button"
                                        class="button-subtle preview-button split-button-option"><?php _e('Preview'); ?></button>
                            </li>
                        </ul>
                    </div>
                </div>
    ...
    public function tags_html($post)
    {
        ...
        if ($user_can_assign_terms) {
            ?>
            <button type="button" class="button-reset button-link tagcloud-link"
